...
msg = {
    ...
    'yoda_running_test_scenario': ["Running test scenario {0}"],
    ...
    'yoda_test_results_db_check_ok': ["Test results database dsn: {0} check ok."],
    'yoda_test_results_db_missing': ["Test results database not created"],
    ...
    'yoda_invalid_handler': ["Handler name have to be a nonempty string, got {0}, value: {1}"],
    ...
    'yoda_html_path_not_exist': ["Path {0} doesn't exists html report will be not created"],
    'yoda_html_path_not_writable': ["Path {0} is not writeable, permission denied"],
    'yoda_html_missing_template': ["Missing template body.html {0}, report will be not created"],
    'yoda_data_invalid_value': ["Invalid {0} value, supported values: {1}"],
    'yoda_data_unknown_type': ["Data type {0} does not exist"],
    'yoda_unknown_attribute': ["Unknown attribute '{0}'"],
    'yoda_unknown_attribute_option': ["Unknown attribute option {0}"]
}
